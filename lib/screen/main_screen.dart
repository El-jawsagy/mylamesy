...
import 'package:mylamesy/screen/doctor/doctor_screen.dart';
import 'package:mylamesy/screen/home_tabs/home_screen.dart';
import 'package:mylamesy/screen/program/program_screen.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            ...
            title: Text('إستشارة طبيب', style: TextStyle(fontWeight: FontWeight.bold),),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.trending_up),
            title: Text('البرامج التفاعلية', style: TextStyle(fontWeight: FontWeight.bold),),

          ),
          BottomNavigationBarItem(
            title: Text('الاطباق الرئيسية', style: TextStyle(fontWeight: FontWeight.bold),),
